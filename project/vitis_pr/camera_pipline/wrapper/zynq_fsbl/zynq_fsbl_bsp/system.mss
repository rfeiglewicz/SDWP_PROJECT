...
BEGIN DRIVER
 ...
 PARAMETER HW_INSTANCE = filter_subsystem_axi_bram_ctrl_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = filter_subsystem_ctrl_ip
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = filter_subsystem_filter_subsystem_ctr_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = pixel_dma_in
 PARAMETER DRIVER_VER = 2.3
 PARAMETER HW_INSTANCE = pixel_dma_in_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = pixel_dma_out
 PARAMETER DRIVER_VER = 1.3
 PARAMETER HW_INSTANCE = pixel_dma_out_0
END
