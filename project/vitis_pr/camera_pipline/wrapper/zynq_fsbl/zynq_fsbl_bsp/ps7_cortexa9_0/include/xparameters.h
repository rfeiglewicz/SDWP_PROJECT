...
/* Definitions for peripheral FILTER_SUBSYSTEM_AXI_BRAM_CTRL_0 */
#define XPAR_FILTER_SUBSYSTEM_AXI_BRAM_CTRL_0_DEVICE_ID 0U
#define XPAR_FILTER_SUBSYSTEM_AXI_BRAM_CTRL_0_DATA_WIDTH 32U
#define XPAR_FILTER_SUBSYSTEM_AXI_BRAM_CTRL_0_ECC 0U
#define XPAR_FILTER_SUBSYSTEM_AXI_BRAM_CTRL_0_FAULT_INJECT 0U
#define XPAR_FILTER_SUBSYSTEM_AXI_BRAM_CTRL_0_CE_FAILING_REGISTERS 0U
#define XPAR_FILTER_SUBSYSTEM_AXI_BRAM_CTRL_0_UE_FAILING_REGISTERS 0U
#define XPAR_FILTER_SUBSYSTEM_AXI_BRAM_CTRL_0_ECC_STATUS_REGISTERS 0U
#define XPAR_FILTER_SUBSYSTEM_AXI_BRAM_CTRL_0_CE_COUNTER_WIDTH 0U
#define XPAR_FILTER_SUBSYSTEM_AXI_BRAM_CTRL_0_ECC_ONOFF_REGISTER 0U
#define XPAR_FILTER_SUBSYSTEM_AXI_BRAM_CTRL_0_ECC_ONOFF_RESET_VALUE 0U
#define XPAR_FILTER_SUBSYSTEM_AXI_BRAM_CTRL_0_WRITE_ACCESS 0U
#define XPAR_FILTER_SUBSYSTEM_AXI_BRAM_CTRL_0_S_AXI_BASEADDR 0x43C60000U
#define XPAR_FILTER_SUBSYSTEM_AXI_BRAM_CTRL_0_S_AXI_HIGHADDR 0x43C61FFFU
#define XPAR_FILTER_SUBSYSTEM_AXI_BRAM_CTRL_0_S_AXI_CTRL_BASEADDR 0xFFFFFFFFU  
#define XPAR_FILTER_SUBSYSTEM_AXI_BRAM_CTRL_0_S_AXI_CTRL_HIGHADDR 0xFFFFFFFFU  


/******************************************************************/

/* Canonical definitions for peripheral FILTER_SUBSYSTEM_AXI_BRAM_CTRL_0 */
#define XPAR_BRAM_0_DEVICE_ID XPAR_FILTER_SUBSYSTEM_AXI_BRAM_CTRL_0_DEVICE_ID
...
#define XPAR_BRAM_0_BASEADDR 0x43C60000U
#define XPAR_BRAM_0_HIGHADDR 0x43C61FFFU
...
/* Definitions for driver FILTER_SUBSYSTEM_CTRL_IP */
#define XPAR_FILTER_SUBSYSTEM_CTRL_IP_NUM_INSTANCES 1

/* Definitions for peripheral FILTER_SUBSYSTEM_FILTER_SUBSYSTEM_CTR_0 */
#define XPAR_FILTER_SUBSYSTEM_FILTER_SUBSYSTEM_CTR_0_DEVICE_ID 0
#define XPAR_FILTER_SUBSYSTEM_FILTER_SUBSYSTEM_CTR_0_S00_AXI_BASEADDR 0x43C50000
#define XPAR_FILTER_SUBSYSTEM_FILTER_SUBSYSTEM_CTR_0_S00_AXI_HIGHADDR 0x43C5FFFF
...
/* Definitions for driver PIXEL_DMA_IN */
#define XPAR_XPIXEL_DMA_IN_NUM_INSTANCES 1

/* Definitions for peripheral PIXEL_DMA_IN_0 */
#define XPAR_PIXEL_DMA_IN_0_DEVICE_ID 0
#define XPAR_PIXEL_DMA_IN_0_S_AXI_AXI_LITE_1_BASEADDR 0x40000000
#define XPAR_PIXEL_DMA_IN_0_S_AXI_AXI_LITE_1_HIGHADDR 0x4000FFFF


/******************************************************************/

/* Canonical definitions for peripheral PIXEL_DMA_IN_0 */
#define XPAR_XPIXEL_DMA_IN_0_DEVICE_ID XPAR_PIXEL_DMA_IN_0_DEVICE_ID
#define XPAR_XPIXEL_DMA_IN_0_S_AXI_AXI_LITE_1_BASEADDR 0x40000000
#define XPAR_XPIXEL_DMA_IN_0_S_AXI_AXI_LITE_1_HIGHADDR 0x4000FFFF


/******************************************************************/

/* Definitions for driver PIXEL_DMA_OUT */
#define XPAR_XPIXEL_DMA_OUT_NUM_INSTANCES 1

/* Definitions for peripheral PIXEL_DMA_OUT_0 */
#define XPAR_PIXEL_DMA_OUT_0_DEVICE_ID 0
#define XPAR_PIXEL_DMA_OUT_0_S_AXI_AXI_LITE_1_BASEADDR 0x40010000
#define XPAR_PIXEL_DMA_OUT_0_S_AXI_AXI_LITE_1_HIGHADDR 0x4001FFFF


/******************************************************************/

/* Canonical definitions for peripheral PIXEL_DMA_OUT_0 */
#define XPAR_XPIXEL_DMA_OUT_0_DEVICE_ID XPAR_PIXEL_DMA_OUT_0_DEVICE_ID
#define XPAR_XPIXEL_DMA_OUT_0_S_AXI_AXI_LITE_1_BASEADDR 0x40010000
#define XPAR_XPIXEL_DMA_OUT_0_S_AXI_AXI_LITE_1_HIGHADDR 0x4001FFFF
...
#define XPAR_FABRIC_PIXEL_DMA_IN_0_INTERRUPT_INTR 63U
#define XPAR_FABRIC_PIXEL_DMA_OUT_0_INTERRUPT_INTR 64U
...
#define XPAR_FABRIC_PIXEL_DMA_IN_0_VEC_ID XPAR_FABRIC_PIXEL_DMA_IN_0_INTERRUPT_INTR
#define XPAR_FABRIC_PIXEL_DMA_OUT_0_VEC_ID XPAR_FABRIC_PIXEL_DMA_OUT_0_INTERRUPT_INTR
