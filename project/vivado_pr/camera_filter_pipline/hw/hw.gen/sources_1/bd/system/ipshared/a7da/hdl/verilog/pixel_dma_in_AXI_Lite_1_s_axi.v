...
// ==============================================================
`timescale 1ns/1ps
module pixel_dma_in_AXI_Lite_1_s_axi
#(parameter
...
localparam
    ...
    ADDR_IER                 = 6'h08,
    ADDR_ISR                 = 6'h0c,
    ADDR_AXI_PIXEL_IN_DATA_0 = 6'h10,
    ADDR_AXI_PIXEL_IN_CTRL   = 6'h14,
    ADDR_FRAME_WIDTH_DATA_0  = 6'h18,
    ADDR_FRAME_WIDTH_CTRL    = 6'h1c,
    ADDR_FRAME_HEIGHT_DATA_0 = 6'h20,
    ADDR_FRAME_HEIGHT_CTRL   = 6'h24,
    WRIDLE                   = 2'd0,
    WRDATA                   = 2'd1,
    WRRESP                   = 2'd2,
    WRRESET                  = 2'd3,
    ...
    if (ACLK_EN) begin
        if (ar_hs) begin
            ...
            case (raddr)
                ...
                ADDR_AXI_PIXEL_IN_DATA_0: begin
                    rdata <= int_axi_pixel_in[31:0];
                end
...
assign axi_pixel_in     = int_axi_pixel_in;
...
// int_axi_pixel_in[31:0]
always @(posedge clk) begin
    if (rst)
        int_axi_pixel_in[31:0] <= 0;
    else if (w_hs && waddr == ADDR_AXI_PIXEL_IN_DATA_0)
        int_axi_pixel_in[31:0] <= (WDATA[31:0] & wmask) | (int_axi_pixel_in[31:0] & ~wmask);
end
// int_frame_width[31:0]
always @(posedge clk) begin
    if (rst)
        int_frame_width[31:0] <= 0;
    else if (w_hs && waddr == ADDR_FRAME_WIDTH_DATA_0)
...
always @(posedge clk) begin
    ...
    else if (w_hs && waddr == ADDR_FRAME_HEIGHT_DATA_0)
